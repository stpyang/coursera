...
object Anagrams {
  ...
  def subtract(x: Occurrences, y: Occurrences): Occurrences = {
    ...
    x.foldLeft(Map[Char, Int]())((map, o) => map.updated(o._1, o._2 - yMap.getOrElse(o._1.toLower, 0))).toList.filter(_._2 != 0).sortWith(_._1 < _._1)
  }
  ...
  def _sentenceAnagrams(occurrences: Occurrences): List[Sentence] = occurrences match {
    ...
    case _ => for {
      ...
      sentence <- _sentenceAnagrams(subtract(occurrences, combo))
      if !combo.isEmpty
    } yield {
      word :: sentence
    }
